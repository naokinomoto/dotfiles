...
(defun tidal-start-haskell ()
  ...
  (tidal-send-string ":load /home/reprimande/src/github.com/reprimande/tidal-tools/zzz.hs")
  (tidal-send-string "import Sound.Tidal.Zzz")
...
(defun tidal-mode-keybindings (map)
  ...
  (define-key map [?\C-z ?\C-1] 'tidal-stop-d1)
  (define-key map [?\C-z ?\C-2] 'tidal-stop-d2)
  (define-key map [?\C-z ?\C-3] 'tidal-stop-d3)
  (define-key map [?\C-z ?\C-4] 'tidal-stop-d4)
  (define-key map [?\C-z ?\C-5] 'tidal-stop-d5)
  (define-key map [?\C-z ?\C-6] 'tidal-stop-d6)
  (define-key map [?\C-z ?\C-7] 'tidal-stop-d7)
  (define-key map [?\C-z ?\C-8] 'tidal-stop-d8)
  (define-key map [?\C-z ?\C-9] 'tidal-stop-d9))
